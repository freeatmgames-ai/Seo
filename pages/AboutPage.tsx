...
const portfolioProjects = [
  ...
  },
  {
    ...
    result2: '50+ New Patient Calls/Mo',
    proofLink: '#',
  },
];
             ...
             <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider w-1/4">Challenge</th>
                    <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider w-1/4">Strategy</th>
                    <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Results</th>
                     ...
                     <tr key={idx} className="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td className="px-6 py-5 align-top">
                           <div className="flex flex-col gap-1.5">
                             ...
                             <span className="text-gray-600 text-xs px-1">{project.result2}</span>
                           </div>
                        </td>
                        <td className="px-6 py-5 align-top text-center">
                           <a href={project.proofLink} className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 text-gray-400 hover:bg-indigo-600 hover:text-white transition-all duration-200" title="View Project">
            ...
            {portfolioProjects.map((project, idx) => (
              <div key={idx} className="bg-white p-6 rounded-xl shadow-md border border-gray-100 flex flex-col gap-4 relative overflow-hidden" data-aos="fade-up">
                 ...
                 <div className="flex justify-between items-start pl-2">
                    ...
                    <a href={project.proofLink} className="p-2 bg-gray-50 rounded-full text-gray-400 hover:bg-indigo-600 hover:text-white transition-colors border border-gray-100">
                 ...
                 <div className="pt-3 border-t border-gray-100 ml-2 mt-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                       <span className="text-green-700 text-xs font-bold bg-green-50 px-2 py-1 rounded border border-green-100">{project.result1}</span>
                       <span className="text-gray-600 text-xs bg-gray-50 px-2 py-1 rounded border border-gray-200">{project.result2}</span>
                    </div>
                 </div>
              </div>
            ))}
